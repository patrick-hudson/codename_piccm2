...
(function() {
  ...
  myApp.controller('settingsKeybindController', function() {
    //this.firstName = "Test";
    this.keyPress = function($event) {
      ...
      console.log(keyboardMap[$event.which]);
    }
  });
  ...
  myApp.directive(
    ...
    function() {
      ...
      return ({
        ...
        link: link,
        restrict: "A",
        templateUrl: 'file://' + __dirname + "/settings.account.html"
      });
  ...
  myApp.controller('PrimaryLayoutController', function() {
    //this.firstName = "Test";
    console.log('hey, fuck you, I am a good programmer.....')
  });
  myApp.directive(
    "secondaryLayout",
    function() {
      ...
      return ({
        ...
        link: link,
        restrict: "A",
        templateUrl: 'file://' + __dirname + "/settings.servers.html"
      });
  ...
  myApp.controller('SecondaryLayoutController', function() {
    //this.firstName = "Test";
  });
})();
